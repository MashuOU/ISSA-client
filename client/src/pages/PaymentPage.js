        ...
        */}
        ...
        <ol class="space-y-4 w-72">
          ...
          <li>
            ...
            <div
              class="w-full p-4 text-red-700 border border-red-300 focus:border-red-600 rounded-lg bg-red-50 dark:bg-gray-800 dark:border-green-800 dark:text-green-400"
              role="alert"
              onClick={() => dispatch(snap(studentDetail?.id))}
            >
              <div class="flex items-center justify-between">
                <span class="sr-only">User info</span>
                <h3 class="font-medium text-kecil2 ">Mohon Selesaikan Pembayaran <br/> sebelum <b> {new Date(SPP.dueDate).toLocaleDateString('id-ID', { day: 'numeric', month: 'long', year: 'numeric' }) } </b>    </h3>
                <svg
                  aria-hidden="true"
                  class="w-5 h-5"
                  fill="currentColor"
