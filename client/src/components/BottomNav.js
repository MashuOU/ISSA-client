...
import { useEffect, useState, useRef } from "react";
  ...
  const [fixOrHide, setFixOrHide] = useState('')
  ...
  return (
    ...
    <div style={{display: fixOrHide}} class="fixed z-50 w-[90%] h-14 max-w-lg -translate-x-1/2 bg-white border border-gray-200 rounded-full bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600">
      <div class="grid h-full max-w-lg grid-cols-5 mx-auto">
        ...
        <button onClick={() => go('/payment')} data-tooltip-target="tooltip-wallet" type="button" class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
          <svg class="w-6 h-6 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <div class="flex items-center justify-center">
          {/* <ion-icon name="chatbubbles-outline" className=" text-white bg-white " ></ion-icon> */}



          <button onClick={() => go('/chat')} data-tooltip-target="tooltip-new" type="button" class="inline-flex items-center justify-center w-10 h-10 font-medium bg-blue-600 rounded-full hover:bg-blue-700 group focus:ring-4 focus:ring-blue-300 focus:outline-none dark:focus:ring-blue-800">
           
            <svg fill="currentColor" className="w-6 h-6 text-white" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <button aria-controls="readProductDrawer" data-drawer-show="readProductDrawer" data-drawer-target="readProductDrawer" id="readProductButton" data-tooltip-target="tooltip-profile" type="button" class="inline-flex flex-col items-center justify-center px-5 rounded-r-full hover:bg-gray-50 dark:hover:bg-gray-800 group">
          <svg class="w-6 h-6 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
