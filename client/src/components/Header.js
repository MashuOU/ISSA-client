  ...
  return (
    <>
      <nav
        ...
        class="bg-white w-[90%]  mx-auto mt-4 z-[10000]  border-red-800  sm:block  px-2 sm:px-4 py-2.5 rounded-xl dark:bg-gray-900"
      >
        <div class="container flex flex-wrap items-center  border-white justify-between mx-auto">
          <a
            href="#"
            style={{}}
            class="flex items-center  border-black ml-2 flex justify-center "
          >
